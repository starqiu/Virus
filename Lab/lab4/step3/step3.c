...
BOOL AddNewSection()
{
	...
	printf("[I] pInjSecHeader:0x%08x\n",pInjSecHeader);
	/*off = (DWORD)pInjSecHeader-(DWORD)pOptHeader->ImageBase+(DWORD)_addr_orign_aoep;
	printf("[I] off:0x%08x\n",off);
	off = (DWORD)pInjSecHeader-(DWORD)pOptHeader->ImageBase;
	printf("[I] off:0x%08x\n",off);*/
